...
import { AlertIcon } from '@/app/components/ui/alert';
...
const LoginPage = () => {
    ...
    return (
        ...
        >
            ...
            <input type="hidden" name="ctl00$mainContent$ddlCampus" id="ctl00_mainContent_ddlCampus" value={campusId} />
            ...
            <div className="relative py-1.5">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-background px-2 text-muted-foreground">or with FeID</span>
                </div>
            </div>
